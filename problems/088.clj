...
(deftest tests-symmetric-difference2
  (testing "test1"
    (is (= (symmetric-difference2 #{1 2 3 4 5 6} #{1 3 5 7}) #{2 4 6 7})))
  (testing "test2"
    (is (= (symmetric-difference2 #{:a :b :c} #{}) #{:a :b :c})))
  (testing "test3"
    (is (= (symmetric-difference2 #{} #{4 5 6}) #{4 5 6})))
  (testing "test4"
    (is (= (symmetric-difference2 #{[1 2] [2 3]} #{[2 3] [3 4]}) #{[1 2] [3 4]}))))
